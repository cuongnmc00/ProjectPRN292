...
INSERT NhanVien ( HoTen, Phai, DiaChi, NgaySinh, SoDt, TaiKhoan, MatKhau) VALUES ( N'Lê Minh Thảo', N'Nam', N'Thanh Hóa', N'11/03/1996', 01229650824, N'admin', N'admin')
INSERT NhanVien ( HoTen, Phai, DiaChi, NgaySinh, SoDt, TaiKhoan, MatKhau) VALUES ( N'Trần Nhân Phúc', N'Nam', N'DakLak', N'11/03/1996',01229650824, N'user1', N'user2')
INSERT NhanVien ( HoTen, Phai, DiaChi, NgaySinh, SoDt, TaiKhoan, MatKhau) VALUES ( N'Mai Anh Tú', N'Nữ', N'Quảng Bình', N'11/03/1996', 0123456789, N'user2', N'user3')
INSERT NhanVien ( HoTen, Phai, DiaChi, NgaySinh, SoDt, TaiKhoan, MatKhau) VALUES ( N'Võ Minh Tuấn An', N'Nam', N'Tây Ninh', N'11/03/1996', 0123456789, N'user3', N'user4')
INSERT NhanVien ( HoTen, Phai, DiaChi, NgaySinh, SoDt, TaiKhoan, MatKhau) VALUES ( N'Đoàn Gia Minh', N'Nam', N'TP HCM', N'11/03/1996', 0123456789, N'user4',N'user5')
